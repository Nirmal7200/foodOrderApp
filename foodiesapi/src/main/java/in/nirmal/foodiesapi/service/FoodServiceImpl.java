...
import in.nirmal.foodiesapi.entity.FoodEntity;
import in.nirmal.foodiesapi.io.FoodRequest;
import in.nirmal.foodiesapi.io.FoodResponse;
import in.nirmal.foodiesapi.repository.FoodRepository;
...
public class FoodServiceImpl implements FoodService{
    ...
    public FoodResponse readFood(String id) {
      ...
      FoodEntity foodEntity =  foodRepository.findById(id).orElseThrow(()-> new RuntimeException("Food not found "+ id));
